import 'package:biblioteca_2app/models/usuario_model.dart';
import 'package:biblioteca_2app/controllers/usuario_controller.dart';
...
class _UsuarioFormViewState extends State<UsuarioFormView> {
  ...
  void initState() {
    super.initState();
    if (widget.user != null) {
      _nomeField.text = widget.user!.nome; //atribui ao campo do formulario
      // as informações do usuário que veio da tela anterior
